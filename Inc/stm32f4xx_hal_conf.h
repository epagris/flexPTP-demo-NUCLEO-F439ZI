...
#define HAL_FMPSMBUS_MODULE_DISABLED
...
#define UID ((const uint8_t *)(0x1FFF7A10))

/* MAC ADDRESS: MAC_ADDR0:MAC_ADDR1:MAC_ADDR2:MAC_ADDR3:MAC_ADDR4:MAC_ADDR5 */
#define MAC_ADDR0 0x00
#define MAC_ADDR1 0x80
#define MAC_ADDR2 0xE1
#define MAC_ADDR3 (UID[2])
#define MAC_ADDR4 (UID[1])
#define MAC_ADDR5 (UID[0])

/* Definition of the Ethernet driver buffers size and count */
#define ETH_BUFFER_SIZE 1528U
#define ETH_RX_BUF_SIZE ETH_BUFFER_SIZE /* ETH Max buffer size for receive       */
#define ETH_TX_BUF_SIZE ETH_BUFFER_SIZE /* ETH Max buffer size for transmit      */
#define ETH_RX_DESC_CNT 24U             /* 24 Rx buffers of size ETH_RX_BUF_SIZE  */
#define ETH_TX_DESC_CNT 6U              /* 6 Tx buffers of size ETH_TX_BUF_SIZE  */
